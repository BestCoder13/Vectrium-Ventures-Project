      ...
      <div className="left w-full lg:w-[45vw] flex items-center justify-center">
        ...
        >
          <img
            src={img}
            alt="vision"
            className='rounded-2xl w-full max-w-[700px] shadow-[0_20px_50px_rgba(0,0,0,0.3)] transition-all duration-300 ease-in-out'
          />
        </motion.div>
      </div>

      <div className="right w-full lg:w-[45vw] text-white">
